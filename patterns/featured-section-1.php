 ...
 * Slug: patterns-photography/featured-section-1
 * Categories: featured
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"width":"80px","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/logo-5.png" style="width:80px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
