 ...
 * Slug: patterns-photography/featured-section-8
...
<h2 class="wp-block-heading has-text-align-center has-base-color"><?php esc_html_e( 'News &amp; Articles', 'patterns-photography' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-quaternary-color has-text-color has-link-color has-small-font-size" style="font-style:normal;font-weight:300"><?php esc_html_e( 'Get The Latest Articles About The Different Aspects Photography', 'patterns-photography' ); ?></p>
<!-- /wp:paragraph -->

</div>
<!-- /wp:group -->

<!-- wp:query {"queryId":0,"query":{"perPage":3,"pages":0,"offset":"1","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"align":"wide"} -->
...
<!-- wp:post-title {"style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"fontSize":"medium"} /-->
