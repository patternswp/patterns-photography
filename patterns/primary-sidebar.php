 ...
 * Slug: patterns-photography/primary-sidebar
 * Categories: posts
...
<div class="wp-block-group">
    <!-- wp:pattern {"slug":"patterns-photography/search-form"} /-->
    <!-- wp:pattern {"slug":"patterns-photography/latest-posts"} /-->
    <!-- wp:pattern {"slug":"patterns-photography/latest-comments"} /-->
</div>
<!-- /wp:group -->