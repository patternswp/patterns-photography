...
/**
 * Title: Footer
 * Slug: patterns-photography/footer
 * Categories: footer
...
<p class="has-default-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy', 'patterns-photography' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<h5 class="wp-block-heading has-base-color has-default-color has-text-color"><?php esc_html_e( 'Contact Info', 'patterns-photography' ); ?></h5>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/icon-4.png"  style="width:16px"/></figure>
<!-- /wp:image -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|default"}}}},"textColor":"default","fontSize":"x-small"} -->
<p class="has-default-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( '60 East 65th Street, New York City, NY 10065', 'patterns-photography' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"16px","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|white"}}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/icon-5.png"  style="width:16px"/></figure>
<!-- /wp:image -->
...
<p class="has-default-color pwp-txt-dec-non has-text-color has-link-color has-x-small-font-size"><a href="<?php echo esc_url( 'mailto:info@example.com' ); ?>"><?php esc_html_e( 'info@example.com', 'patterns-photography' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"className":"pwp-txt-dec-non","style":{"elements":{"link":{"color":{"text":"var:preset|color|default"}}}},"textColor":"default","fontSize":"x-small"} -->
<p class="has-default-color pwp-txt-dec-non has-text-color has-link-color has-x-small-font-size"><a href="<?php echo esc_url( 'tel:(629) 555-0129' ); ?>"><?php esc_html_e( '(629) 555-0129', 'patterns-photography' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:column {"width":"25%"} -->
<div class="wp-block-column" style="flex-basis:25%"><!-- wp:heading {"level":5,"className":"has-base-color","textColor":"default"} -->
<h5 class="wp-block-heading has-base-color has-default-color has-text-color"><?php esc_html_e( 'Follow Us', 'patterns-photography' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|default"}}}},"textColor":"default","fontSize":"x-small"} -->
<p class="has-default-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'The perfect place for telling &amp; sharing all the stories that truly matter.', 'patterns-photography' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"margin":{"top":"25px"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
<div class="wp-block-group" style="margin-top:25px"><!-- wp:social-links {"iconColor":"default","iconColorValue":"#ffffff","size":"has-small-icon-size","align":"center","className":"is-style-logos-only","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|20"}}}} -->
...
<!-- wp:column {"width":"25%"} -->
<div class="wp-block-column" style="flex-basis:25%"><!-- wp:heading {"level":5,"className":"has-base-color","textColor":"default"} -->
<h5 class="wp-block-heading has-base-color has-default-color has-text-color"><?php esc_html_e( 'Recent News', 'patterns-photography' ); ?></h5>
<!-- /wp:heading -->
...
<div class="wp-block-group alignfull has-background" style="background-color:#1f1f1f4d;padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20)">
    <!-- wp:pattern {"slug":"patterns-photography/copyright"} /-->
...
<!-- wp:pattern {"slug":"patterns-photography/scroll-to-top-button"} /-->
