 ...
 * Slug: patterns-photography/hidden-primary-header
 * Inserter: no
 *
...
<div class="wp-block-group has-default-color has-text-color has-link-color" style="line-height:0.2"><!-- wp:image {"width":"16px","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|primary"}}} -->
...
<p class="has-x-small-font-size" style="line-height:1"><?php esc_html_e( 'Mon - Fri 9:00 -17:00', 'patterns-photography' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="pwp-txt-dec-non has-x-small-font-size" style="line-height:1"><a href="<?php echo esc_url( 'tel:(629) 555-0129' ); ?>"><?php esc_html_e( '(629) 555-0129', 'patterns-photography' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"className":"pwp-txt-dec-non","style":{"typography":{"lineHeight":"1"}},"fontSize":"x-small"} -->
<p class="pwp-txt-dec-non has-x-small-font-size" style="line-height:1"><a href="<?php echo esc_url( 'mailto:info@example.com' ); ?>"><?php esc_html_e( 'info@example.com', 'patterns-photography' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
    ...
    <div class="wp-block-group alignwide">	
        ...
        <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"},"layout":{"selfStretch":"fill","flexSize":null}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
            <div class="wp-block-group"> 
                <!-- wp:pattern {"slug":"patterns-photography/site-identity"} /-->
                <!-- wp:pattern {"slug":"patterns-photography/navigation-menu"} /-->
            </div>
        <!-- /wp:group -->

        <!-- wp:buttons -->
        <div class="wp-block-buttons"><!-- wp:button -->
        <div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Hire Us Now', 'patterns-photography' ); ?></a></div>
        <!-- /wp:button --></div>
        <!-- /wp:buttons -->
