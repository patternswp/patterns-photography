 ...
 * @subpackage Patterns_Photography/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Photography_Api' ) ) {

	/**
	 * Patterns_Photography_Api
	 *
	 * @package Patterns_Photography
	 * @since 1.0.1
	 */
	class Patterns_Photography_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-photography' ), '1.0.0' );
		}
